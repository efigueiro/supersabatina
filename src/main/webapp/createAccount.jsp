        ...
        <div class="container">
            <div class="row p-md-5">
                <div class="col-sm-6 p-4 justify-content-center">
                    <img src="img/girlbookaccount.png" alt="" class="img-fluid d-none d-sm-block" />
                </div>
                ...
                <div class="col-sm-6 p-4 justify-content-center">
                    <form action="createAccount" method="post">
                        ...
                        <div class="mb-3 mt-3">
                            <input type="text" class="form-control" id="txtUserName" name="txtUserName" placeholder="Nome de usuário" required/>
                        </div>
                        <div class="mb-3 mt-3">
